export const DAILY_TIPS = {
  menstrual: [
    ...
    { icon: "\u{1F4A7}", tip: "Mantente hidratada. La perdida de sangre puede deshidratarte. Agrega limon al agua para mejorar la absorción de hierro." },
    { icon: "\u{1F34A}", tip: "Combina alimentos ricos en hierro con vitamina C. Unas gotas de limon sobre las espinacas triplican la absorción." },
  ],
  folicular: [
    ...
    { icon: "\u{1F966}", tip: "Las cruciferas como brocoli y coliflor ayudan a tu hígado a metabolizar el estrogeno que va en aumento." },
  ...
  ovulatoria: [
    ...
    { icon: "\u{1F95A}", tip: "Los huevos son perfectos hoy: proteina completa, colina y vitamina D que apoyan la función reproductiva." },
